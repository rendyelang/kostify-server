...
const { addRoom, getRooms, getRoomsByOwnerId, editRoom, editRoomStatus, deleteRoom, getRoomById, getAvailableRoomsByOwner, getFullRoombyOwner } = require('../controllers/roomController')
...
router.get('/rooms/full/me', protectedToken, getFullRoombyOwner)
